...
(cd intellij-community && git clone git://git.jetbrains.org/idea/android.git android && cd android &&  git fetch --all --tags && git checkout tags/idea/233.14015.106 && git apply ../../patches/android.patch)
